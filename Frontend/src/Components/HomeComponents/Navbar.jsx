      ...
      <div className="max-w-screen-2xl container mx-auto shadow-md md:px-20 fixed top-0 left-0 bg-sky-300 z-10 dark:bg-indigo-950 dark:text-white">
        <div className="navbar">
          <div className="navbar-start">
            ...
            <Link to="/" className="bg-transparent text-blue-700 drop-shadow-lg font-bold cursor-pointer border-none text-3xl font-[Agbalumo]">iBook</Link>
          </div>
          ...
          <div className="navbar-end">
...

            {
              authUser? (
                ...
                <div>
                  <Link onClick={() => document.getElementById("my_modal_3").showModal()} className=" px-5 py-3 rounded-xl cursor-pointer bg-slate-900 border-none text-white hover:bg-white hover:text-black duration-300 dark:bg-slate-950 dark:hover:bg-white">Login</Link>
                  <Login />
                </div> 
              )
            }
